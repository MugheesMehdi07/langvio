...
class YOLOResultFormatter:
    ...
    def create_enhanced_video_results(
            ...
            temporal_tracker: Any, spatial_analyzer: Any,
            counter_results: Any, speed_results: Any,
            video_props: Tuple, query_params: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _create_comprehensive_object_analysis(
            self, temporal_tracker: Any, movement_patterns: Dict[str, Any], spatial_summary: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _extract_primary_insights(
            self, query_params: Dict[str, Any], yolo11_metrics: Dict[str, Any],
            movement_patterns: Dict[str, Any], spatial_summary: Dict[str, Any]
    ) -> List[str]:
